  ...
  <div class="container-fluid justify-content-center align-items-center honestyContainer" ref="container">
    <div class="d-flex flex-column align-items-center">
      <transition name="bounce">
        <div v-if="show" class="d-flex flex-column align-items-center justify-content-center">
          <h1 class="honestyHeader font-weight-bold" ref="honestyHeader">Well done!</h1>
        </div>
      </transition>
      <div class="d-flex align-items-center justify-content-center">
        <h2 class="honestyScore" ref="honestyScore">Your score is:</h2>
        <transition name="bounce">
      ...
      <transition name="bounce">
        <div v-if="show" class="mt-3 btn btn-success font-weight-bold honestButton">Let's be honest</div>
      </transition>
    </div>
    <div v-if="!show">
